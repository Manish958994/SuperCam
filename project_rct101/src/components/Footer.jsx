...
//     href: string;
  ...
  export default function Footer() {
    return (
      <Box
        bg={useColorModeValue("#003677")}
        color={useColorModeValue('white', 'white')}>
        <Container as={Stack} maxW={'6xl'} py={10}>
          <SimpleGrid
            templateColumns={{ sm: '1fr 1fr', md: '1fr 1fr 1fr 2fr' }}
            spacing={8}>
          <Stack align={'flex-start'} fontSize={'13px'}>
              ...
              <Link href={'#'}>Warranties</Link>
              <Link href={'#'}>Accessibility Policy</Link>
            </Stack>
            <Stack align={'flex-start'} fontSize={'13px'}>
              <ListHeader>Services & Programs</ListHeader>
              <Link href={'#'}>Adorama Business, Education, & Government </Link>
              <Link href={'#'}>Adorama Edge Credit Card</Link>
              <Link href={'#'}>VIP Rewards </Link>
              <Link href={'#'}>Students</Link>
              <Link href={'#'}>Adorama Protect</Link>
              <Link href={'#'}>Photo Printing </Link>
              <Link href={'#'}>Camera Rentals</Link>
              <Link href={'#'}>Sell Used Equipment </Link>
              <Link href={'#'}>Authorized Apple Service</Link>
           
            </Stack>
            <Stack align={'flex-start'} fontSize={'13px'}>
              <ListHeader>Who We Are</ListHeader>
              <Link href={'#'}>About Adorama</Link>
              <Link href={'#'}>Our History</Link>
              <Link href={'#'}>Creator Highlights</Link>
              <Link href={'#'}>Adorama Reviews</Link>
              <Link href={'#'}>Map & Directions</Link>
            ...
            <Stack align={'flex-start'} fontSize={'15px'}>
              ...
              <Text>Sign up for special offers, product news, exclusive deals, and more. Plus, VIP Reward Members earn $10 in reward points, $20 for VIP Pro members when they sign up through 2/28/23.</Text>
             <br />
             <br />
...
_placeholderShown={{
    ...
    fontcolor:"red"
                ...
                />
<Button  bg={"#0060c0"}  borderRadius=" 0 5px 5px 0"   color={useColorModeValue('white')}
                  _hover={{
                    bg: 'green.600',
                  }} >Submit</Button>
              ...
              <br />
              <br />
              <Stack direction={'row'} fontSize="25px" >
                <Text>Follow Us: </Text>
